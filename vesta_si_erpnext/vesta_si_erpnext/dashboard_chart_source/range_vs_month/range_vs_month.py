...
def get_data(filters=None):
    ...
    return {
        ...
        "datasets" : [
            {
                'name': label1,
                'values': [ chart_data_map["January"][0], chart_data_map["February"][0], chart_data_map["March"][0], chart_data_map["April"][0], chart_data_map["May"][0], chart_data_map["June"][0], chart_data_map["July"][0], chart_data_map["August"][0], chart_data_map["September"][0], chart_data_map["Octomber"][0], chart_data_map["November"][0], chart_data_map["December"][0]],
            },
            {
                'name': label2,
