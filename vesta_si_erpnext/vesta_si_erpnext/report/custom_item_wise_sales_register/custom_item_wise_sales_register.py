...
from erpnext.accounts.report.item_wise_sales_register.item_wise_sales_register import execute as parent_report
...
def execute(filters=None):
	...
	for datum in data:
		if datum["item_code"] and datum["invoice"]:
			datum["item_tax_template"] = frappe.db.get_value("Sales Invoice Item",
