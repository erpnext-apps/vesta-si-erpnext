...
def execute(filters=None):
	...
	monthly_data = [
			...
			"posting_percentage" : round((january_proce_days_posting / (january_proce_days + january_proce_days_posting)) * 100, 2)  if january_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((february_proce_days_posting / (february_proce_days+february_proce_days_posting)) * 100, 2)  if february_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((march_proce_days_posting / (march_proce_days_posting + march_proce_days)) * 100, 2)  if march_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((april_proce_days_posting / (april_proce_days + april_proce_days_posting)) * 100, 2)  if april_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((may_proce_days_posting / (may_proce_days + may_proce_days_posting)) * 100, 2)  if may_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((june_proce_days_posting / (june_proce_days + june_proce_days_posting)) * 100, 2)  if june_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((july_proce_days_posting / (july_proce_days + july_proce_days_posting)) * 100, 2)  if july_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((august_proce_days_posting / (august_proce_days + august_proce_days_posting)) * 100, 2)  if august_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((september_proce_days_posting / (september_proce_days + september_proce_days_posting)) * 100, 2)  if september_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((october_proce_days_posting / (october_proce_days_posting + october_proce_days)) * 100, 2)  if october_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((november_proce_days_posting / (november_proce_days+november_proce_days_posting)) * 100, 2)  if november_proce_days_posting else 0
			}, 
			...
			"posting_percentage" : round((december_proce_days_posting / (december_proce_days+december_proce_days_posting)) * 100, 2)  if  december_proce_days_posting else 0
			},
		]
