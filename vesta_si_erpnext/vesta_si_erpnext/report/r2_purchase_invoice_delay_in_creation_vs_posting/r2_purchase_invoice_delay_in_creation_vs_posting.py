...
def execute(filters=None):
	...
	monthly_data = [
			...
			"creation_percentage" : round(december_proce_days/december_proce_days_posting * 100, 2)  if december_proce_days_posting else 0,
			"posting_percentage" : round(december_processing_days / december_proce_days_posting * 100, 2)  if  december_proce_days_posting else 0
			},
		]
